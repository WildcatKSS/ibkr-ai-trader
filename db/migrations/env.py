...
# Build the database URL via URL.create() so special characters in the
# password (e.g. @, :, /, %) are percent-encoded automatically.
# A raw f-string would produce a malformed connection string for such values.
_db_url = URL.create(
